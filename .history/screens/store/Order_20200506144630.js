                ...
                {({ cartItems, Total }) =>
                    <View style={styles.container}>
                        ...
                        <View style={styles.infor}>
                            ...
                            <TextInput  placeholder="Nhập tên của bạn ở đây"  
                                        onChangeText={(nameUser) => this.setState({nameUser})}/>
                             <Text>- Số điện thoại người nhận:</Text>
                            <TextInput  placeholder="Nhập số điện thoại của bạn ở đây"  
                                        onChangeText={(nameUser) => this.setState({nameUser})}/> 
                             <Text>- Địa chỉ người nhận:</Text>
                            <TextInput  placeholder="Nhập địa chỉ của bạn ở đây"  style={backgroundColor= '#fff'}
                                        onChangeText={(nameUser) => this.setState({nameUser})}/>
                        </View>
