...
import { StyleSheet, FlatList, AsyncStorage, View, Text, TextInput, Button, Picker} from 'react-native';
export default class AddProduct extends React.Component {
  ...
  render() {
    const [selectedValue, setSelectedValue] = this.state
    return (
      <View style={styles.container}>
        ...
        <View style={styles.component}>
          ...
          <Picker
          electedValue = {this.state.user} onValueChange = {this.updateUser}>
