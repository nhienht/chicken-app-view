...
export default class AddProduct extends React.Component {
    ...
    updateValue = async (selectedValue) => {
                ...
                {({ onChange , chooseProduct}) =>
                    <View style={styles.container}>
                        ...
                        <View style={styles.component}>
                            ...
                            <TextInput placeholder="nhập số lượng" value={chooseProduct.quantity} onChange={(e)=>onChange(e, "quantity")}></TextInput>
                        </View>
                        <View style={styles.component}>
                        ...
                        <View style={styles.component}>
                            ...
                            <Picker selectedValue = {this.state.selectedValue} onValueChange = {this.updateValue}>
