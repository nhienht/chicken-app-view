    ...
    render() {
        return (
            <StoreContext.Consumer>
                {({ chooseProduct, onChange, updateValue }) =>
                    <View style={styles.container}>
                        ...
                        <View style={styles.component}>
                            ...
                            <TextInput placeholder="nhập số lượng" value={JSON.stringify(chooseProduct.quantity)} onChange={(e) => onChange(e, "quantity")}></TextInput>
                        </View>
                        <View style={styles.component}>
                        ...
                        <Button title="Cập nhật" onPress={()=> updateValue} ></Button>
                </View>
                  }
            </StoreContext.Consumer>
