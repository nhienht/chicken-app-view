...
export class CartProvider extends React.Component {
    ...
    addToCart(item) {
        ...
        if (existItem.length > 0) {
            ...
            this.setState({
                ...
                Total: JSON.stringify(JSON.parseInt(this.state.Total) + JSON.parseInt(item.price))
            })
        }
        else {
    ...
    removeItem(item){
        ...
        this.setState({
            ...
            Total : JSON.stringify(JSON.parseInt(this.state.Total) - JSON.parseInt(item.price*count))
        })
    }
